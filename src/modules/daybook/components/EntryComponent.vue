<template>
    ...
    @click="$router.push({name:'entry', params: {id: 10}})">
        ...
        <div class="entry-description">
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nam odit laudantium veniam quos aut illum magni cum laborum porro eum saepe, nobis sit dicta nulla facere ratione! Praesentium, quos sint.
        </div>
    </div>
</template>
